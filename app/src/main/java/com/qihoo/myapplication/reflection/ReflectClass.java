package com.qihoo.myapplication.reflection;
...
public class ReflectClass {
    ...
    public static void reflectNewInstance() {
        try {
            Class<?> classBook = Class.forName("com.qihoo.myapplication.reflection.Book");
    ...
    public static void reflectPrivateMethod() {
        ...
        try {
            classBook = Class.forName("com.qihoo.myapplication.reflection.Book");
            Object objectBook = classBook.newInstance();
